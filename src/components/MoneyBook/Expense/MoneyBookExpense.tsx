...
const MoneyBookExpense = () => {
    ...
    return (
        <div className="lg:ml-52 ml-14 bg-[#fbfbfb] min-w-[35rem] w-full flex justify-center items-center" onClick={clickFalse}>
            ...
            <div>
                <div>
                    <div>수입</div>
                    <ExpenseItem type={"수입"} data={flow_data?.data} />
                </div>
                <div>
                    <div>지출</div>
                    <ExpenseItem type={"지출"} data={flow_data?.data} />
                </div>
            </div>
        </div>
    )
