...
const ExpenseItemModal = ({ setModal, item, modalData }: any) => {
    ...
    return (
        <div className="fixed top-0 left-0 flex items-center justify-center w-full h-full bg-white bg-opacity-50" onClick={() => setModal(false)}>
            <div onClick={(e) => e.stopPropagation()} className="flex flex-col p-10 z-1000 bg-white lg:w-[60%] max-w-[70rem] w-[60%] lg:ml-52 ml-14 border rounded">
