...
const CalendarFlow = ({ day, flow_data }: { day: number, flow_data: any }) => {
    ...
    return (
        <div className={`absolute lg:-top-16 top-0  ${condition ? "left-[10.5rem] animate-fade-right" : "right-[10.5rem] animate-fade-left"}  flex flex-col bg-[#ececec] shadow-xl lg:w-80 lg:h-80 w-40 h-[10.9rem]  animate-duration-150 animate-ease-in rounded`} onClick={(e) => e.stopPropagation()}>
